<template>
  ...
  >
    ...
    <!-- <Icon name="uil:heart" class="cursor-pointer text-slate-500" /> -->
  </div>
</template>
...
.showCard {
  width: 240px;
  height: 380px;
  transition: transform 0.3s ease; /* Add this line for transition */
}
...
.showCard:hover {
  ...
  transform: translate(5px, -5px); /* Adjust the translation as needed */
}
