<template>
  <header class="dark:bg-slate-900 dark:text-slate-100 p-12">
    <nav>
      <ul
        class="flex flex-wrap justify-center gap-2 m-auto rounded-lg lg:justify-around items-center px-4 py-4 dark:shadow-red-500 border-b-200 shadow-lg lg:flex-row md:flex-wrap sm:flex-wrap"
      >
        <NuxtLink
        ...
        <div class="text-red-500" @click="toggleTheme()">
          <Icon
            name="heroicons-solid:sun"
            class="cursor-pointer text-3xl dark:text-slate-100"
          />
        </div>
      </ul>
    </nav>
  ...
  <footer class="dark:bg-slate-900 dark:text-slate-100 static bottom-0">
    <li class="list-none flex justify-center text-slate-400 border-t-2 py-2 dark:border-red-500">
